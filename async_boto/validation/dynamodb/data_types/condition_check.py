...
class ConditionCheck(BaseModel):
    ...
    Key : AttributeValueDict
        The primary key of the item to be checked. Each element consists of an attribute name and a value for that attribute. Maximum length of 65535.
    ...
    ExpressionAttributeNames : Optional[Dict[str, str]]
        One or more substitution tokens for attribute names in an expression. Maximum length of 65535.
    ...
    ReturnValuesOnConditionCheckFailure : Optional[Literal["ALL_OLD", "NONE"]]
        Use ReturnValuesOnConditionCheckFailure to get the item attributes if the ConditionCheck condition fails. Valid values are: NONE and ALL_OLD.
    """
