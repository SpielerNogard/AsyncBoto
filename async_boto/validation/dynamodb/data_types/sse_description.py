...
class SSEDescription(BaseModel):
    ...
    Status : Optional[Literal['ENABLING', 'ENABLED', 'DISABLING', 'DISABLED', 'UPDATING']]
    ...
    SSEType: Optional[Literal["AES256", "KMS"]] = None
    Status: Optional[
        Literal["ENABLING", "ENABLED", "DISABLING", "DISABLED", "UPDATING"]
    ] = None
